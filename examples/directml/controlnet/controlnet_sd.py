...
import torch
import diffusers
from diffusers import OnnxRuntimeModel, ControlNetModel, UniPCMultistepScheduler,StableDiffusionImg2ImgPipeline
...
def run_inference(
    ...
    if static_dims:
        ...
        sess_options.add_free_dimension_override_by_name("condition_height", image_size)
        sess_options.add_free_dimension_override_by_name("condition_width", image_size)
...
def optimize(
    ...
    controlnet_base_model_id=controlnet_id
    ...
    controlnet = ControlNetModel.from_pretrained(controlnet_base_model_id, torch_dtype=torch.float16)
    pipeline = StableDiffusionImg2ImgPipeline.from_pretrained(base_model_id, controlnet=controlnet,torch_dtype=torch.float16)
    ...
    for submodel_name in submodel_names:
        ...
        if submodel_name in ("unet", "text_encoder"):
            ...
            olive_config["input_model"]["config"]["model_path"] = controlnet_id
...
if __name__ == "__main__":
    ...
    parser.add_argument("--controlnet_id", default="lllyasviel/sd-controlnet-openpose", type=str)
    parser.add_argument("--control_image_path", default="https://huggingface.co/datasets/YiYiXu/controlnet-testing/resolve/main/yoga2.jpeg", type=str)
    ...
    parser.add_argument("--negative_prompt",default="monochrome, lowres, bad anatomy, worst quality, low quality", type=str)
    ...
    parser.add_argument(
        "--prompt",
        default=(
            "super-hero character, best quality, extremely detailed"
        ),
        type=str,
    )
    ...
    if args.optimize:
        ...
        with warnings.catch_warnings():
            ...
            optimize(args.model_id, args.provider, unoptimized_model_dir, optimized_model_dir,args.controlnet_id)
